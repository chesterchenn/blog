...
物理层定义的规范有：EIA/TIA RS-232、EIA/TIA RS-449、V.35、RJ-45 等。
...
网络层协议的代表有：IP、ICMP、IGMP、IPX、RIP、OSPF 等。
...
- [网络知识梳理--OSI 七层网络与 TCP/IP 五层网络架构及二层/三层网](https://www.cnblogs.com/kevingrace/p/5909719.html)
