...
2. 接口 interface
   ...
   ![UML-Interface](/images/UML-Interface.png)

3. 协作 Collaboration

   一个大的行为或者行为模式。图形表示：

   ![UML-Collaboration](/images/UML-Collaboration.svg)

4. 用例 Use Case

   系统执行的一系列动作，并产生一个可观察的结果。图形表示：

   ![UML-UseCase](/images/UML-UseCase.svg)

5. 主动类 Active Class

   跟类类似，表示与其他行为并发的行为。图形表示：

   ![UML-ActiveClass](/images/UML-ActiveClass.svg)

6. 组件 Component

   系统实现的部分接口的物理或可替换的部分。图形表示：

   ![UML-Component](/images/UML-Component.svg)

7. 结点 Node

   运行时存在的物理元素，表示资源。图形表示：

   ![UML-Node](/images/UML-Node.svg)
...
1. 交互 Interaction
   ...
   ![UML-Display](/images/UML-Display.svg)

2. 状态 State-Machine

   规定了对象或交互在其生命周期内的状态。

   ![UML-State](/images/UML-State.svg)

### 分组事物

分组事物（grouping thing）是 UML 模型的组织部分，是一些由模型分解成的“盒子”。在所有的分组事物中，最主要的分组事物是包（package）。包的图形表示：

![UML-Package](/images/UML-Package.svg)
...
![UML-Comment](/images/UML-Comment.svg)
